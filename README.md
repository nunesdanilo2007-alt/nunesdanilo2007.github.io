...
<body class="bg-gray-50 text-gray-800">
  ...
  <section class="bg-pink-600 text-white py-16 text-center px-6">
    ...
    <a href="#oferta" class="inline-block mt-6 bg-white text-pink-600 font-semibold py-3 px-8 rounded-2xl shadow-md hover:bg-gray-100 transition">Quero Transformar Minha Vida Agora</a>
  </section>
  ...
  <section id="oferta" class="bg-white py-16 px-6 text-center">
    ...
    <a href="#cta" class="inline-block mt-6 bg-pink-600 hover:bg-pink-700 text-white font-semibold py-4 px-10 rounded-2xl shadow-md transition">Sim, Eu Quero Vencer a Procrastinação Agora!</a>
  </section>
